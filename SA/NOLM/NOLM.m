...
% INPUT FIELD ************************************************************
P_peak = 2*N2*abs(mod.betaw(3))/mod.gamma/tfwhm^2;    % Peak power of the initial pulse (W)   	
...
[ubo,nf,Plotdata_b] = IP_CQEM_FD(ub,dt,dz,mod,fo,tol,1);
[ufo,nf,Plotdata_f] = IP_CQEM_FD(uf,dt,dz,mod,fo,tol,1);
