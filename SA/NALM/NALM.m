...
amf = smf1;
amf.L = 0.00015;
amf.gssdB = 30;                         % small signal gain coefficient(dB)
amf.PsatdBm = 60;                     	% saturation input power(dBm)
amf.lamda_gain = lamda_pulse;         	% central wavelength of gain (nm)
amf.landa_bw = 150;                   	% gain bandwidth (FWHM, nm)
amf.fc = c/amf.lamda_gain;              % central frequency of gain (THz)
amf.fbw = c/(amf.lamda_gain)^2*amf.landa_bw;   % gain bandwidth (THz)

% smf2 module parameters
smf2 = smf1;
smf2.L = 0.002-smf1.L-amf.L;
...
[ufo,nf,Plotdata_f] = IP_CQEM_FD(ufo,dt,dz,amf,fo,tol,1);
...
[ubo,nf,Plotdata_b] = IP_CQEM_FD(ubo,dt,dz,amf,fo,tol,1);
